...
export default class AuthController {
  private endpoint = "/api/createAccount";
  ...
  /**
   * Crea una cuenta simulando el envío del formulario web real
   ...
   */
  async createAccount(csrfToken: string, userDetails: UserModel) {
